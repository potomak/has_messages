module Xinuc
  module HasMessages
    ...
    module ModelInstanceMethods
      ...
      def send_message(receiver, subject, body, attachment = nil)
        @message = Message.new(
          :receiver   => receiver,
          :sender     => self,
          :subject    => subject,
        ...
        @message.save
        @message.deliver_message_notification! if (defined?(MessageMailer) and MessageMailer.respond_to?(:message_notification))
      end

      def reply_message(message, subject, body, attachment = nil)
        @message = Message.new(
